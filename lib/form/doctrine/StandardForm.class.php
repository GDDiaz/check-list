...
class StandardForm extends BaseStandardForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['is_killer_q'] = new sfWidgetFormInputCheckbox(array(), array( 'class' => 'form-control'));
      ...
      $this->widgetSchema['is_killer_q']->setLabel('¿Es un criterio obligatorio ?');
      $this->validatorSchema->setPostValidator(
          new sfValidatorCallback(array('callback' => array($this, 'checkWeight')))
      );

      $this->useFields(['name', 'template_id', 'weight', 'is_killer_q']);
  }
